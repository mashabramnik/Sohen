...
<script type="text/javascript">
  ...
  <?php
    $parent0 = 0;
    mysqli_set_charset($mysqli,'utf8');				
	$res_productType_byProducer = $mysqli->query("SELECT name , idParent FROM producttype WHERE producer_id='".$producer_id."'");
  ...
  ?>  	
            <li class= "parrent_0"><a href="#"><?php echo $row[0]; ?></a></li>	
  <?php
				}
			}
		}
